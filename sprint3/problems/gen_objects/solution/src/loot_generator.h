...
private:
    // Безопасное значение по умолчанию: без явно переданного генератора
    // случайных чисел трофеи никогда не появляются. Это заставляет вызывающий
    // код осознанно передать настоящий источник случайности.
